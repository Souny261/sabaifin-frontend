...
export default function HeroSection() {
    ...
    return (
        <div id='hero' className="container mx-auto px-4  flex flex-col min-h-screen  justify-centeritems-center relative z-10 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-screen justify-start">
                ...
                <div className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight bg-gradient-to-r from-gray-800 via-gray-900 to-black bg-clip-text text-transparent">
                        ເຂົ້າໃຈການ<span className="text-primary">ຜ່ອນ ແລະ ດອກເບ້ຍ</span>ກ່ອນຕັດສິນໃຈຂໍສິນເຊື່ອ
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 my-8">
                        <Button
                            ...
                            onClick={() => {
                                gtag.event({
                                    action: '[Button] - Started Calculator',
                                    category: 'engagement',
                        ...
                        <Button
                            onClick={() => {
                                gtag.event({
                                    action: '[Button] - Started Partners',
                                    category: 'engagement',
                                    label: 'Subscribe Button',
                                    value: 1,
                                })
